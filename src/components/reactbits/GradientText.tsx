...
export default function GradientText({
  ...
  return (
    <motion.div
      className={`relative inline-flex max-w-fit flex-row items-center rounded-[1.25rem] transition-shadow duration-500 overflow-hidden ${showBorder ? 'py-1 px-2 backdrop-blur' : ''} ${className}`}
