  ...
  return (
    <>
      ...
      <nav className={containerClassName} style={style} aria-label="Main navigation">
        ...
        >
          <span
            className={['logo-content', 'inline-flex items-center justify-center', 'w-auto min-w-max h-full whitespace-nowrap px-1'].join(' ')}
            style={
              {
                ['--logo-max-height']: '60%',
                ['--logo-max-width']: '100%'
        ...
        <div className="flex items-center gap-3 pointer-events-auto">
          ...
          <button
            ...
            className={[
              ...
              'border border-stone-300 dark:border-stone-700 cursor-pointer p-0',
              'will-change-transform'
            ].join(' ')}
