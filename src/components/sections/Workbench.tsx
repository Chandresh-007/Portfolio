    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        >
          ...
          <h2 className="font-display font-black text-4xl sm:text-6xl md:text-7xl tracking-tight text-stone-900 dark:text-stone-100 leading-none mb-4">
            STILL FIGURING IT OUT.
          </h2>
          <p className="text-xl md:text-2xl text-stone-600 dark:text-stone-300 font-light max-w-2xl leading-relaxed">
